#!/bin/bash
# CloudMount Nautilus Script: Open Online (SharePoint)
#
# This script allows you to open files from CloudMount mounts in SharePoint/Office Online
# by right-clicking in Nautilus and selecting Scripts > "Open Online (SharePoint)".
#
# INSTALLATION:
# 1. Copy this script to ~/.local/share/nautilus/scripts/
# 2. Make it executable: chmod +x ~/.local/share/nautilus/scripts/Open\ Online\ \(SharePoint\)
