...
#[test]
fn test_packaged_defaults_load_empty_returns_default() -> cloudmount_core::Result<()> {
    ...
    assert_eq!(defaults.app_name(), "CloudMount");
...
#[test]
fn test_packaged_defaults_load_full_config() -> cloudmount_core::Result<()> {
    let toml_str = r#"
[tenant]
...
"#;
    ...
    assert_eq!(defaults.app_name(), "MyOrg CloudMount");
...
#[test]
fn test_effective_config_packaged_only() -> cloudmount_core::Result<()> {
    let packaged_toml = r#"
[tenant]
id = "tenant-123"
...
#[test]
fn test_effective_config_user_overrides_packaged() -> cloudmount_core::Result<()> {
    let packaged_toml = r#"
[defaults]
auto_start = false
cache_max_size = "5GB"
...
#[test]
fn test_mount_union_merge() -> cloudmount_core::Result<()> {
    let packaged_toml = r#"
[[mounts]]
id = "pkg-mount1"
name = "Packaged Drive"
...
#[test]
fn test_mount_override_applies() -> cloudmount_core::Result<()> {
    let packaged_toml = r#"
[[mounts]]
id = "mount1"
name = "Original Name"
...
#[test]
fn test_dismissed_mounts_excluded() -> cloudmount_core::Result<()> {
    let packaged_toml = r#"
[[mounts]]
id = "mount1"
name = "Mount 1"
...
#[test]
fn test_restore_default_mounts() -> cloudmount_core::Result<()> {
    let user_toml = r#"
