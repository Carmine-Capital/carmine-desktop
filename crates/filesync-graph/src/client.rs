...
pub struct GraphClient {
    ...
    token_fn: Box<
        dyn Fn() -> std::pin::Pin<
                Box<dyn std::future::Future<Output = filesync_core::Result<String>> + Send>,
            > + Send
            + Sync,
    >,
}
...
impl GraphClient {
    ...
    where
        ...
        Fut: std::future::Future<Output = filesync_core::Result<String>> + Send + 'static,
    {
        Self {
            http: Client::new(),
    ...
    async fn token(&self) -> filesync_core::Result<String> {
        (self.token_fn)().await
    }
    ...
    async fn get_json<T: serde::de::DeserializeOwned>(
        ...
        with_retry(|| async {
            ...
            let resp = self
                ...
                .send()
                .await
                .map_err(|e| filesync_core::Error::Network(e.to_string()))?;

            Self::handle_error(resp)
                .await?
                .json::<T>()
                .await
                .map_err(|e| filesync_core::Error::GraphApi {
                    status: 0,
    ...
    async fn handle_error(resp: reqwest::Response) -> filesync_core::Result<reqwest::Response> {
        ...
        if status == StatusCode::TOO_MANY_REQUESTS {
            ...
            return Err(filesync_core::Error::GraphApi {
                status: 429,
        ...
        Err(filesync_core::Error::GraphApi {
            status: status.as_u16(),
            message: body,
        })
    }

    pub async fn get_my_drive(&self) -> filesync_core::Result<Drive> {
    ...
    pub async fn list_children(
        ...
        drive_id: &str,
        item_id: &str,
    ) -> filesync_core::Result<Vec<DriveItem>> {
        let base_url = &self.base_url;
    ...
    pub async fn get_item(
        ...
        drive_id: &str,
        item_id: &str,
    ) -> filesync_core::Result<DriveItem> {
        let base_url = &self.base_url;
    ...
    pub async fn create_upload_session(
        ...
        drive_id: &str,
        item_id: &str,
    ) -> filesync_core::Result<UploadSession> {
        let base_url = &self.base_url;
        let token = self.token().await?;
    ...
    pub async fn upload(
        ...
        if content.len() < SMALL_FILE_LIMIT {
            ...
            let id = item_id.ok_or_else(|| filesync_core::Error::GraphApi {
                status: 0,
    ...
    pub async fn delete_item(&self, drive_id: &str, item_id: &str) -> filesync_core::Result<()> {
        let base_url = &self.base_url;
        let token = self.token().await?;
    ...
    pub async fn delta_query(
    ...
    ) -> filesync_core::Result<DeltaResponse> {
        let base_url = &self.base_url;
        ...
        loop {
            ...
            match result {
                ...
                Err(filesync_core::Error::GraphApi { status: 410, .. }) => {
    ...
    pub async fn search_sites(&self, query: &str) -> filesync_core::Result<Vec<Site>> {
        let base_url = &self.base_url;
    ...
    pub async fn get_followed_sites(&self) -> filesync_core::Result<Vec<Site>> {
        let base_url = &self.base_url;
    ...
    pub async fn list_site_drives(&self, site_id: &str) -> filesync_core::Result<Vec<Drive>> {
        let base_url = &self.base_url;
