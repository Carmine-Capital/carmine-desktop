# CfApi Local Change Sync

## Purpose
Manages ingestion and upload of local file changes on Windows Cloud Files API mounts, including non-placeholder changes, safe-save transactions, pending writeback retries, and observable ingest decisions.
