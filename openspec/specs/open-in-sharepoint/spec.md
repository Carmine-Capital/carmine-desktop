...
Allow users to open files directly in SharePoint from their local filesystem, enabling desktop co-authoring in Office applications and browser-based editing for non-Office files.
