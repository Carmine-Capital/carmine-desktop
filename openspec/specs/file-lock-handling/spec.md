...
Detect and handle Microsoft 365 file locks (co-authoring sessions, SharePoint checkouts) during open and upload operations, using conflict copies to preserve local changes when uploads are rejected with 423 Locked.
