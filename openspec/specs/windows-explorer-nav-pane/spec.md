## Purpose
Defines the Windows Explorer navigation pane integration for Carmine Desktop, allowing the cloud root directory to appear as a persistent node in Explorer's left sidebar via delegate folder CLSID registration.
